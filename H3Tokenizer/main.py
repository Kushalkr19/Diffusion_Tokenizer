...
class MAEPreTrainer(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        samples, mask = batch
        spat_recon_loss, spec_recon_loss, code_loss, _, spat_recon, spec_recon = self.model(samples, mask)
    ...
    def validation_step(self, batch, batch_idx):
        samples, mask = batch
        spat_recon_loss, spec_recon_loss, code_loss,  _,recon,_ = self.model(samples,mask)
